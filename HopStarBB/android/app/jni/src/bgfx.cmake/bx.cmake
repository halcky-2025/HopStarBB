...
target_compile_definitions(bx
    PUBLIC
        ...
        # NOTE: BX_CONFIG_DEBUG=1 enables BX_ASSERT, which on Android trips a
        # bgfx internal inconsistency: vk init picks BGRA8 backbuffer but
        # bgfx's cap table reports BGRA8 lacks the BACKBUFFER bit, so the
        # assert in Context::reset SIGTRAPs even though the swapchain works.
        # Force =0 so the assert is compiled out; logs still flow.
        BX_CONFIG_DEBUG=0
)

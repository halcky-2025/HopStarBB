...
inline void ColumnMetaCheck(ThreadGC* thgc, char* data) {
    ColumnMeta* c = (ColumnMeta*)data;
    c->name = (String*)copy_object_young(thgc, (char*)c->name);
}
struct RowSet {
    Map* columns;
    Map* rows;
...
inline void TableCheck(ThreadGC* thgc, char* data) {
    Table* t = (Table*)data;
    t->name    = (String*)copy_object_young(thgc, (char*)t->name);
    t->sqlname = (String*)copy_object_young(thgc, (char*)t->sqlname);
}
...
inline void ColumnCheck(ThreadGC* thgc, char* data) {
    Column* c = (Column*)data;
    c->name    = (String*)copy_object_young(thgc, (char*)c->name);
    c->sqlname = (String*)copy_object_young(thgc, (char*)c->sqlname);
    c->type    = (String*)copy_object_young(thgc, (char*)c->type);
}

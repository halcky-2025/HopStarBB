...
inline void SBCheck(ThreadGC* thgc, char* data) {
    SB* sb = (SB*)data;
    if (sb->str.data) {
        sb->str.data = (char*)copy_object_young(thgc, sb->str.data);
    }
}
...
inline void traceLComp(ThreadGC* thgc, LComp* c) {
    c->comps = (List*)copy_object_young(thgc, (char*)c->comps);
}
inline void LCompCheck(ThreadGC* thgc, char* data) {
    traceLComp(thgc, (LComp*)data);
}
...
inline void LVariCheck(ThreadGC* thgc, char* data) {
    LVari* v = (LVari*)data;
    traceLComp(thgc, (LComp*)v);
    v->type = (String*)copy_object_young(thgc, (char*)v->type);
    v->name = (String*)copy_object_young(thgc, (char*)v->name);
}
...
inline void LStrVCheck(ThreadGC* thgc, char* data) {
    LStrV* v = (LStrV*)data;
    traceLComp(thgc, (LComp*)v);
    v->type  = (String*)copy_object_young(thgc, (char*)v->type);
    v->name  = (String*)copy_object_young(thgc, (char*)v->name);
    v->value = (String*)copy_object_young(thgc, (char*)v->value);
}
...
inline void LLabCheck(ThreadGC* thgc, char* data) {
    LLab* l = (LLab*)data;
    traceLComp(thgc, (LComp*)l);
...
inline void LIfValueCheck(ThreadGC* thgc, char* data) {
    LIfValue* i = (LIfValue*)data;
    traceLComp(thgc, (LComp*)i);
    i->lab = (LLab*) copy_object_young(thgc, (char*)i->lab);
    i->v   = (LVari*)copy_object_young(thgc, (char*)i->v);
}
...
inline void LPhiCheck(ThreadGC* thgc, char* data) {
    LPhi* p = (LPhi*)data;
    traceLComp(thgc, (LComp*)p);
    p->y    = (LVari*)copy_object_young(thgc, (char*)p->y);
    p->vmap = (Map*)  copy_object_young(thgc, (char*)p->vmap);
}
...
inline void LTypeDecCheck(ThreadGC* thgc, char* data) {
    LTypeDec* t = (LTypeDec*)data;
    traceLComp(thgc, (LComp*)t);
    t->name   = (String*)copy_object_young(thgc, (char*)t->name);
    t->option = (String*)copy_object_young(thgc, (char*)t->option);
}
...
inline void LTypeValCheck(ThreadGC* thgc, char* data) {
    LTypeVal* t = (LTypeVal*)data;
    traceLComp(thgc, (LComp*)t);
    t->type = (String*)copy_object_young(thgc, (char*)t->type);
    t->name = (String*)copy_object_young(thgc, (char*)t->name);
}
...
inline void LFuncCheck(ThreadGC* thgc, char* data) {
    LFunc* f = (LFunc*)data;
    traceLComp(thgc, (LComp*)f);
    f->y              = (LVari*)      copy_object_young(thgc, (char*)f->y);
    f->draws          = (List*)       copy_object_young(thgc, (char*)f->draws);
    f->dbinits        = (List*)       copy_object_young(thgc, (char*)f->dbinits);
    f->vari           = (LVari*)      copy_object_young(thgc, (char*)f->vari);
    f->sc             = (LSwitchComp*)copy_object_young(thgc, (char*)f->sc);
    f->llvm           = (LLLVM*)      copy_object_young(thgc, (char*)f->llvm);
    f->debugVariables = (List*)       copy_object_young(thgc, (char*)f->debugVariables);
}
...
inline void LGeteCheck(ThreadGC* thgc, char* data) {
    LGete* g = (LGete*)data;
    traceLComp(thgc, (LComp*)g);
    g->type = (String*)copy_object_young(thgc, (char*)g->type);
    g->y    = (LVari*) copy_object_young(thgc, (char*)g->y);
    g->x    = (LVari*) copy_object_young(thgc, (char*)g->x);
}
...
inline void LCastCheck(ThreadGC* thgc, char* data) {
    LCast* c = (LCast*)data;
    traceLComp(thgc, (LComp*)c);
    c->y = (LVari*)copy_object_young(thgc, (char*)c->y);
    c->x = (LVari*)copy_object_young(thgc, (char*)c->x);
}
...
inline void LCallCheck(ThreadGC* thgc, char* data) {
    LCall* c = (LCall*)data;
    traceLComp(thgc, (LComp*)c);
    c->y = (LVari*)copy_object_young(thgc, (char*)c->y);
    c->f = (LVari*)copy_object_young(thgc, (char*)c->f);
}
...
inline void LAllocaCheck(ThreadGC* thgc, char* data) {
    LAlloca* a = (LAlloca*)data;
    traceLComp(thgc, (LComp*)a);
    a->a = (LVari*)copy_object_young(thgc, (char*)a->a);
}
...
inline void LStoreCheck(ThreadGC* thgc, char* data) {
    LStore* s = (LStore*)data;
    traceLComp(thgc, (LComp*)s);
    s->y = (LVari*)copy_object_young(thgc, (char*)s->y);
    s->a = (LVari*)copy_object_young(thgc, (char*)s->a);
}
...
inline void LLoadCheck(ThreadGC* thgc, char* data) {
    LLoad* l = (LLoad*)data;
    traceLComp(thgc, (LComp*)l);
    l->y = (LVari*)copy_object_young(thgc, (char*)l->y);
    l->a = (LVari*)copy_object_young(thgc, (char*)l->a);
}
...
inline void LBrCheck(ThreadGC* thgc, char* data) {
    LBr* b = (LBr*)data;
    traceLComp(thgc, (LComp*)b);
    b->a = (LVari*)copy_object_young(thgc, (char*)b->a);
}
...
inline void LSwitchCompCheck(ThreadGC* thgc, char* data) {
    LSwitchComp* s = (LSwitchComp*)data;
    traceLComp(thgc, (LComp*)s);
    s->x      = (LVari*)copy_object_young(thgc, (char*)s->x);
    s->lab    = (LLab*) copy_object_young(thgc, (char*)s->lab);
    s->values = (List*) copy_object_young(thgc, (char*)s->values);
}
...
inline void LBinOpCheck(ThreadGC* thgc, char* data) {
    LBinOp* o = (LBinOp*)data;
    traceLComp(thgc, (LComp*)o);
    o->y = (LVari*)copy_object_young(thgc, (char*)o->y);
    o->a = (LVari*)copy_object_young(thgc, (char*)o->a);
    o->b = (LVari*)copy_object_young(thgc, (char*)o->b);
}
...
inline void LCmpCheck(ThreadGC* thgc, char* data) {
    LCmp* c = (LCmp*)data;
    traceLComp(thgc, (LComp*)c);
    c->y = (LVari*)copy_object_young(thgc, (char*)c->y);
    c->a = (LVari*)copy_object_young(thgc, (char*)c->a);
    c->b = (LVari*)copy_object_young(thgc, (char*)c->b);
}
...
inline void LLocationMarkerCheck(ThreadGC* thgc, char* data) {
    traceLComp(thgc, (LComp*)data);
}
...
inline void LRetCheck(ThreadGC* thgc, char* data) {
    LRet* r = (LRet*)data;
    traceLComp(thgc, (LComp*)r);
    r->a = (LVari*)copy_object_young(thgc, (char*)r->a);
}
...
inline void LDebugVariableCheck(ThreadGC* thgc, char* data) {
    LDebugVariable* d = (LDebugVariable*)data;
    d->name = (String*)copy_object_young(thgc, (char*)d->name);
}
...
inline void LStructFieldCheck(ThreadGC* thgc, char* data) {
    LStructField* f = (LStructField*)data;
    f->name     = (String*)copy_object_young(thgc, (char*)f->name);
    f->llvmType = (String*)copy_object_young(thgc, (char*)f->llvmType);
}
...
inline void LStructTypeInfoCheck(ThreadGC* thgc, char* data) {
    LStructTypeInfo* s = (LStructTypeInfo*)data;
    s->fields = (List*)  copy_object_young(thgc, (char*)s->fields);
...
inline void LDebugInfoCheck(ThreadGC* thgc, char* data) {
    LDebugInfo* d = (LDebugInfo*)data;
    d->fileIds       = (Map*) copy_object_young(thgc, (char*)d->fileIds);
    d->functionIds   = (Map*) copy_object_young(thgc, (char*)d->functionIds);
    d->typeIds       = (Map*) copy_object_young(thgc, (char*)d->typeIds);
    d->structTypeIds = (Map*) copy_object_young(thgc, (char*)d->structTypeIds);
    d->structTypes   = (Map*) copy_object_young(thgc, (char*)d->structTypes);
    d->locations     = (Map*) copy_object_young(thgc, (char*)d->locations);
    d->locationKeys  = (List*)copy_object_young(thgc, (char*)d->locationKeys);
    d->locationVals  = (List*)copy_object_young(thgc, (char*)d->locationVals);
    d->pointerTypes  = (Map*) copy_object_young(thgc, (char*)d->pointerTypes);
    d->ptrBaseIds    = (List*)copy_object_young(thgc, (char*)d->ptrBaseIds);
    d->ptrTypeIds    = (List*)copy_object_young(thgc, (char*)d->ptrTypeIds);
}
...
inline void LLLVMCheck(ThreadGC* thgc, char* data) {
    LLLVM* l = (LLLVM*)data;
    traceLComp(thgc, (LComp*)l);
    l->local        = (Master*)    copy_object_young(thgc, (char*)l->local);
    l->strs         = (List*)      copy_object_young(thgc, (char*)l->strs);
    l->types        = (List*)      copy_object_young(thgc, (char*)l->types);
    l->funcs        = (List*)      copy_object_young(thgc, (char*)l->funcs);
    l->main_func    = (LFunc*)     copy_object_young(thgc, (char*)l->main_func);
    l->main         = (LFunc*)     copy_object_young(thgc, (char*)l->main);
    l->tagvars      = (List*)      copy_object_young(thgc, (char*)l->tagvars);
    l->tagvarvars   = (List*)      copy_object_young(thgc, (char*)l->tagvarvars);
    l->tagparents   = (List*)      copy_object_young(thgc, (char*)l->tagparents);
    l->tagparenttes = (List*)      copy_object_young(thgc, (char*)l->tagparenttes);
    l->debugInfo    = (LDebugInfo*)copy_object_young(thgc, (char*)l->debugInfo);
    l->sourceFile   = (String*)    copy_object_young(thgc, (char*)l->sourceFile);
    l->directory    = (String*)    copy_object_young(thgc, (char*)l->directory);
}
...
LVari* make_lvari(ThreadGC* thgc, String* type, String* name) {
    ...
    v->comptype = LC_Vari;
    v->debugLocationId = -1;
    v->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    v->type = type;
    v->name = name;
    return v;
}
...
LLab* make_llab(ThreadGC* thgc, String* name) {
    ...
    l->comptype = LC_Lab;
    l->debugLocationId = -1;
    l->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    l->name = name;
    return l;
}
...
LIfValue* make_lifvalue(ThreadGC* thgc, LLab* lab, LVari* v) {
    ...
    iv->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    iv->lab = lab;
    iv->v = v;
    iv->check = false;
    return iv;
...
LPhi* make_lphi(ThreadGC* thgc, LVari* y, Map* vmap) {
    ...
    p->comptype = LC_Phi;
    p->debugLocationId = -1;
    p->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    p->y = y;
    p->vmap = vmap;
    return p;
}
...
LTypeDec* make_ltypedec(ThreadGC* thgc, String* name, String* option, bool func) {
    ...
    t->debugLocationId = -1;
    t->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    t->name = name;
    t->option = option;
    t->func = func;
    return t;
...
LGete* make_lgete(ThreadGC* thgc, String* type, LVari* y, LVari* x) {
    ...
    g->comptype = LC_Gete;
    g->debugLocationId = -1;
    g->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    g->type = type;
    g->y = y;
    g->x = x;
    return g;
...
LCast* make_lcast(ThreadGC* thgc, LCastType casttype, LVari* y, LVari* x) {
    ...
    c->comptype = LC_Cast;
    c->debugLocationId = -1;
    c->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    c->casttype = casttype;
    c->y = y;
    c->x = x;
    c->debugVarId = -1;
...
LAlloca* make_lalloca(ThreadGC* thgc, LVari* a) {
    ...
    al->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    al->a = a;
    return al;
}
...
LStore* make_lstore(ThreadGC* thgc, LVari* y, LVari* a) {
    ...
    s->comptype = LC_Store;
    s->debugLocationId = -1;
    s->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    s->y = y;
    s->a = a;
    return s;
}
...
LBr* make_lbr(ThreadGC* thgc, LVari* a) {
    ...
    b->comptype = LC_Br;
    b->debugLocationId = -1;
    b->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    b->a = a;
    return b;
}
...
LBinOp* make_lbinop(ThreadGC* thgc, LBinOpType optype, LVari* y, LVari* a, LVari* b) {
    ...
    op->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    op->optype = optype;
    op->y = y;
    op->a = a;
    op->b = b;
...
LLocationMarker* make_llocmarker(ThreadGC* thgc, int line, int column, int scopeId) {
    ...
    m->debugLocationId = -1;
    m->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    m->line = line;
    m->column = column;
    m->scopeId = scopeId;
    m->metaid = -1;
...
LRet* make_lret(ThreadGC* thgc, LVari* a) {
    ...
    r->comptype = LC_Ret;
    r->debugLocationId = -1;
    r->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    r->a = a;
    return r;
}
...
LDebugInfo* make_ldebuginfo(ThreadGC* thgc) {
    ...
    d->metaId = 0;
    d->fileIds = create_mapy(thgc, CType::_Struct);
    d->functionIds = create_mapy(thgc, CType::_Struct);
    d->typeIds = create_mapy(thgc, CType::_Struct);
    d->structTypeIds = create_mapy(thgc, CType::_Struct);
    d->structTypes = create_mapy(thgc, CType::_LStructTypeInfo);
    d->locationKeys = create_list(thgc, sizeof(int), CType::_Struct);
    d->locationVals = create_list(thgc, sizeof(LLocationMarker*), CType::_LLocationMarker);
    d->ptrBaseIds = create_list(thgc, sizeof(int), CType::_Struct);
    d->ptrTypeIds = create_list(thgc, sizeof(int), CType::_Struct);
...
LFunc* make_lfunc(ThreadGC* thgc, LLLVM* llvm, LVari* y) {
    ...
    f->comptype = LC_Func;
    f->debugLocationId = -1;
    f->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    f->y = y;
    f->draws = create_list(thgc, sizeof(LVari*), CType::_LVari);
    f->dbinits = create_list(thgc, sizeof(LComp*), CType::_LComp);
    f->vari = NULL;
    f->async_flag = false;
    f->optnone = false;
    f->sc = NULL;
    f->currentLine = 1;
    f->llvm = llvm;
    f->debugVariables = create_list(thgc, sizeof(LDebugVariable*), CType::_LDebugVariable);
...
LVari* make_lvari_sc(ThreadGC* thgc, String* type, const char* name) {
    return make_lvari(thgc, type,
        createString(thgc, (char*)name, (int)strlen(name), 1));
}

LLab* make_llab_s(ThreadGC* thgc, String* name) {
    return make_llab(thgc, name);
}
...
LLLVM* make_lllvm(ThreadGC* thgc, Master* local) {
    ...
    l->comps = create_list(thgc, sizeof(LComp*), CType::_LComp);
    l->local = local;
    l->strs = create_list(thgc, sizeof(LStrV*), CType::_LStrV);
    l->types = create_list(thgc, sizeof(LTypeDec*), CType::_LTypeDec);
    l->funcs = create_list(thgc, sizeof(LFunc*), CType::_LFunc);
    l->main_func = NULL;
    l->cn = 0;
    l->tagvars = create_list(thgc, sizeof(String*), CType::_String);
    l->tagvarvars = create_list(thgc, sizeof(LVari*), CType::_LVari);
    l->tagparents = create_list(thgc, sizeof(LVari*), CType::_LVari);
    l->tagparenttes = create_list(thgc, sizeof(LVari*), CType::_LVari);
    ...
    {
        // @test body: create GC class, allocate object, create torch modules, register them
        LVari* gfclass = make_lvari_c(thgc, "%GC_AddClassType*", "@GC_AddClass");
        LVari* gfmalloc = make_lvari_c(thgc, "%GC_mallocType*", "@GC_malloc");
        LVari* gfmodule = make_lvari_c(thgc, "%CreateTorchModuleType*", "@CreateTorchModule");
        LVari* gfconv = make_lvari_c(thgc, "%CreateConv2dType*", "@CreateConv2d");
        LVari* gfrel = make_lvari_c(thgc, "%CreateReLUType*", "@CreateReLU");
        LVari* gffla = make_lvari_c(thgc, "%CreateFlattenType*", "@CreateFlatten");
        LVari* gflin = make_lvari_c(thgc, "%CreateLinearType*", "@CreateLinear");
        LVari* gfreg = make_lvari_c(thgc, "%RegisterModuleType*", "@RegisterModule");
        LVari* lfclass = make_lvari_c(thgc, "%GC_AddClassType", "%lfclass");
        LVari* lfmalloc = make_lvari_c(thgc, "%GC_mallocType", "%lfmalloc");
        LVari* lfmodule = make_lvari_c(thgc, "%CreateTorchModuleType", "%lfmodule");
        LVari* lfconv = make_lvari_c(thgc, "%CreateConv2dType", "%lfconv");
        LVari* lfrel = make_lvari_c(thgc, "%CreateReLUType", "%lfrel");
        LVari* lffla = make_lvari_c(thgc, "%CreateFlattenType", "%lffla");
        LVari* lflin = make_lvari_c(thgc, "%CreateLinearType", "%lflin");
        LVari* lfreg = make_lvari_c(thgc, "%RegisterModuleType", "%lfreg");

        // %lfclass = load %GC_AddClassType, %GC_AddClassType* @GC_AddClass
        add_list(thgc, testFunc->comps, (char*)make_lload(thgc, lfclass, gfclass, false));

        // %cls = call i32 %lfclass(i32 32, %GCCheckFuncType null, %GCFinalizeFuncType null)
        LVari* cls = make_lvari_c(thgc, "i32", "%cls");
        LCall* lfcl = make_lcall(thgc, cls, lfclass);
        add_list(thgc, lfcl->comps, (char*)make_lvari_c(thgc, "i32", "32"));
        add_list(thgc, lfcl->comps, (char*)make_lvari_c(thgc, "%GCCheckFuncType", "null"));
        add_list(thgc, lfcl->comps, (char*)make_lvari_c(thgc, "%GCFinalizeFuncType", "null"));
        add_list(thgc, testFunc->comps, (char*)lfcl);

        // %lfmalloc = load %GC_mallocType, %GC_mallocType* @GC_malloc
        add_list(thgc, testFunc->comps, (char*)make_lload(thgc, lfmalloc, gfmalloc, false));

        // %obj = call %GCObjectPtr %lfmalloc(%cls)
        LVari* obj = make_lvari_c(thgc, "%GCObjectPtr", "%obj");
        LCall* lfma = make_lcall(thgc, obj, lfmalloc);
        add_list(thgc, lfma->comps, (char*)cls);
        add_list(thgc, testFunc->comps, (char*)lfma);

        // %lfmodule = load %CreateTorchModuleType, %CreateTorchModuleType* @CreateTorchModule
        add_list(thgc, testFunc->comps, (char*)make_lload(thgc, lfmodule, gfmodule, false));

        // %val = call %torch.nn.ModuleImpl* %lfmodule(%obj, @forward)
        LVari* val = make_lvari_c(thgc, "%torch.nn.ModuleImpl*", "%val");
        LCall* lfm = make_lcall(thgc, val, lfmodule);
        add_list(thgc, lfm->comps, (char*)obj);
        add_list(thgc, lfm->comps, (char*)make_lvari_c(thgc, "%ForwardType", "@forward"));
        add_list(thgc, testFunc->comps, (char*)lfm);

        // %lfconv = load %CreateConv2dType, %CreateConv2dType* @CreateConv2d
        add_list(thgc, testFunc->comps, (char*)make_lload(thgc, lfconv, gfconv, false));

        // %val2 = call %torch.nn.Conv2dImpl* %lfconv(i64 3, i64 16, i64 3)
        LVari* val2 = make_lvari_c(thgc, "%torch.nn.Conv2dImpl*", "%val2");
        LCall* lfc = make_lcall(thgc, val2, lfconv);
        add_list(thgc, lfc->comps, (char*)make_lvari_c(thgc, "i64", "3"));
        add_list(thgc, lfc->comps, (char*)make_lvari_c(thgc, "i64", "16"));
        add_list(thgc, lfc->comps, (char*)make_lvari_c(thgc, "i64", "3"));
        add_list(thgc, testFunc->comps, (char*)lfc);

        // %tobj = bitcast %GCObjectPtr %obj to %TestType*
        LVari* valt = make_lvari_c(thgc, "%TestType*", "%tobj");
        add_list(thgc, testFunc->comps, (char*)make_lcast(thgc, LCAST_Bitcast, valt, obj));

        // %convptr = getelementptr %TestType, %TestType* %tobj, i32 0, i32 0
        LVari* convptr = make_lvari_c(thgc, "%torch.nn.Conv2dImpl*", "%convptr");
        LGete* geteconv = make_lgete(thgc, createString(thgc, (char*)"%TestType", 9, 1), convptr, valt);
        add_list(thgc, geteconv->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, geteconv->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, testFunc->comps, (char*)geteconv);

        // store %torch.nn.Conv2dImpl* %val2, %torch.nn.Conv2dImpl* %convptr
        add_list(thgc, testFunc->comps, (char*)make_lstore(thgc, convptr, val2));

        // %lfreg = load %RegisterModuleType, %RegisterModuleType* @RegisterModule
        add_list(thgc, testFunc->comps, (char*)make_lload(thgc, lfreg, gfreg, false));

        // %str1 = getelementptr [6 x i8], [6 x i8]* @.str.conv1, i64 0, i64 0
        LVari* str1 = make_lvari_c(thgc, "i8*", "%str1");
        LGete* gete1 = make_lgete(thgc, createString(thgc, (char*)"[6 x i8]", 9, 1), str1, make_lvari_c(thgc, "[6 x i8]*", "@.str.conv1"));
        add_list(thgc, gete1->comps, (char*)make_lvari_c(thgc, "i64", "0"));
        add_list(thgc, gete1->comps, (char*)make_lvari_c(thgc, "i64", "0"));
        add_list(thgc, testFunc->comps, (char*)gete1);

        // %bit1 = bitcast %torch.nn.Conv2dImpl* %val2 to %torch.nn.ModuleImpl*
        LVari* bit1 = make_lvari_c(thgc, "%torch.nn.ModuleImpl*", "%bit1");
        add_list(thgc, testFunc->comps, (char*)make_lcast(thgc, LCAST_Bitcast, bit1, val2));

        // call void %lfreg(%val, %str1, %bit1)
        LCall* lfrg1 = make_lcall(thgc, NULL, lfreg);
        add_list(thgc, lfrg1->comps, (char*)val);
        add_list(thgc, lfrg1->comps, (char*)str1);
        add_list(thgc, lfrg1->comps, (char*)bit1);
        add_list(thgc, testFunc->comps, (char*)lfrg1);

        // ReLU
        add_list(thgc, testFunc->comps, (char*)make_lload(thgc, lfrel, gfrel, false));
        LVari* val3 = make_lvari_c(thgc, "%torch.nn.ReLUImpl*", "%val3");
        LCall* lfr = make_lcall(thgc, val3, lfrel);
        add_list(thgc, lfr->comps, (char*)make_lvari_c(thgc, "i1", "false"));
        add_list(thgc, testFunc->comps, (char*)lfr);

        LVari* reluptr = make_lvari_c(thgc, "%torch.nn.ReLUImpl*", "%reluptr");
        LGete* geterelu = make_lgete(thgc, createString(thgc, (char*)"%TestType", 9, 1), reluptr, valt);
        add_list(thgc, geterelu->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, geterelu->comps, (char*)make_lvari_c(thgc, "i32", "1"));
        add_list(thgc, testFunc->comps, (char*)geterelu);

        add_list(thgc, testFunc->comps, (char*)make_lstore(thgc, reluptr, val3));

        LVari* str2 = make_lvari_c(thgc, "i8*", "%str2");
        LVari* bit2 = make_lvari_c(thgc, "%torch.nn.ModuleImpl*", "%bit2");
        add_list(thgc, testFunc->comps, (char*)make_lcast(thgc, LCAST_Bitcast, bit2, val3));
        LGete* gete2 = make_lgete(thgc, createString(thgc, (char*)"[6 x i8]", 9, 1), str2, make_lvari_c(thgc, "[6 x i8]*", "@.str.relu1"));
        add_list(thgc, gete2->comps, (char*)make_lvari_c(thgc, "i64", "0"));
        add_list(thgc, gete2->comps, (char*)make_lvari_c(thgc, "i64", "0"));
        add_list(thgc, testFunc->comps, (char*)gete2);

        LCall* lfrg2 = make_lcall(thgc, NULL, lfreg);
        add_list(thgc, lfrg2->comps, (char*)val);
        add_list(thgc, lfrg2->comps, (char*)str2);
        add_list(thgc, lfrg2->comps, (char*)bit2);
        add_list(thgc, testFunc->comps, (char*)lfrg2);

        // Flatten
        add_list(thgc, testFunc->comps, (char*)make_lload(thgc, lffla, gffla, false));
        LVari* val5 = make_lvari_c(thgc, "%torch.nn.FlattenImpl*", "%val5");
        LCall* lff = make_lcall(thgc, val5, lffla);
        add_list(thgc, lff->comps, (char*)make_lvari_c(thgc, "i64", "1"));
        add_list(thgc, lff->comps, (char*)make_lvari_c(thgc, "i64", "-1"));
        add_list(thgc, testFunc->comps, (char*)lff);

        LVari* flatptr = make_lvari_c(thgc, "%torch.nn.FlattenImpl*", "%flatptr");
        LGete* geteflat = make_lgete(thgc, createString(thgc, (char*)"%TestType", 9, 1), flatptr, valt);
        add_list(thgc, geteflat->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, geteflat->comps, (char*)make_lvari_c(thgc, "i32", "2"));
        add_list(thgc, testFunc->comps, (char*)geteflat);

        add_list(thgc, testFunc->comps, (char*)make_lstore(thgc, flatptr, val5));

        LVari* str4 = make_lvari_c(thgc, "i8*", "%str4");
        LVari* bit4 = make_lvari_c(thgc, "%torch.nn.ModuleImpl*", "%bit4");
        add_list(thgc, testFunc->comps, (char*)make_lcast(thgc, LCAST_Bitcast, bit4, val5));
        LGete* gete4 = make_lgete(thgc, createString(thgc, (char*)"[6 x i8]", 9, 1), str4, make_lvari_c(thgc, "[6 x i8]*", "@.str.flat1"));
        add_list(thgc, gete4->comps, (char*)make_lvari_c(thgc, "i64", "0"));
        add_list(thgc, gete4->comps, (char*)make_lvari_c(thgc, "i64", "0"));
        add_list(thgc, testFunc->comps, (char*)gete4);

        LCall* lfrg4 = make_lcall(thgc, NULL, lfreg);
        add_list(thgc, lfrg4->comps, (char*)val);
        add_list(thgc, lfrg4->comps, (char*)str4);
        add_list(thgc, lfrg4->comps, (char*)bit4);
        add_list(thgc, testFunc->comps, (char*)lfrg4);

        // Linear: 16*62*46 = 45632
        add_list(thgc, testFunc->comps, (char*)make_lload(thgc, lflin, gflin, false));
        LVari* val4 = make_lvari_c(thgc, "%torch.nn.LinearImpl*", "%val4");
        LCall* lfl = make_lcall(thgc, val4, lflin);
        add_list(thgc, lfl->comps, (char*)make_lvari_c(thgc, "i64", "45632"));
        add_list(thgc, lfl->comps, (char*)make_lvari_c(thgc, "i64", "2"));
        add_list(thgc, lfl->comps, (char*)make_lvari_c(thgc, "i1", "true"));
        add_list(thgc, testFunc->comps, (char*)lfl);

        LVari* lineptr = make_lvari_c(thgc, "%torch.nn.LinearImpl*", "%lineptr");
        LGete* geteline = make_lgete(thgc, createString(thgc, (char*)"%TestType", 9, 1), lineptr, valt);
        add_list(thgc, geteline->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, geteline->comps, (char*)make_lvari_c(thgc, "i32", "3"));
        add_list(thgc, testFunc->comps, (char*)geteline);

        add_list(thgc, testFunc->comps, (char*)make_lstore(thgc, lineptr, val4));

        LVari* str3 = make_lvari_c(thgc, "i8*", "%str3");
        LVari* bit3 = make_lvari_c(thgc, "%torch.nn.ModuleImpl*", "%bit3");
        add_list(thgc, testFunc->comps, (char*)make_lcast(thgc, LCAST_Bitcast, bit3, val4));
        LGete* gete3 = make_lgete(thgc, createString(thgc, (char*)"[6 x i8]", 9, 1), str3, make_lvari_c(thgc, "[6 x i8]*", "@.str.line1"));
        add_list(thgc, gete3->comps, (char*)make_lvari_c(thgc, "i64", "0"));
        add_list(thgc, gete3->comps, (char*)make_lvari_c(thgc, "i64", "0"));
        add_list(thgc, testFunc->comps, (char*)gete3);

        LCall* lfrg3 = make_lcall(thgc, NULL, lfreg);
        add_list(thgc, lfrg3->comps, (char*)val);
        add_list(thgc, lfrg3->comps, (char*)str3);
        add_list(thgc, lfrg3->comps, (char*)bit3);
        add_list(thgc, testFunc->comps, (char*)lfrg3);

        // ret %torch.nn.ModuleImpl* %val
        add_list(thgc, testFunc->comps, (char*)make_lret(thgc, val));
    }
    ...
    {
        // @forward body: load each module from TestType struct, call forward on each
        LVari* gfconv = make_lvari_c(thgc, "%ForwardConv2dType*", "@ForwardConv2d");
        LVari* gfrelu = make_lvari_c(thgc, "%ForwardReLUType*", "@ForwardReLU");
        LVari* gfflat = make_lvari_c(thgc, "%ForwardFlattenType*", "@ForwardFlatten");
        LVari* gfline = make_lvari_c(thgc, "%ForwardLinearType*", "@ForwardLinear");
        LVari* lfconv = make_lvari_c(thgc, "%ForwardConv2dType", "%lfconv");
        LVari* lfrelu = make_lvari_c(thgc, "%ForwardReLUType", "%lfrelu");
        LVari* lfflat = make_lvari_c(thgc, "%ForwardFlattenType", "%lfflat");
        LVari* lfline = make_lvari_c(thgc, "%ForwardLinearType", "%lfline");

        // %tobj = bitcast i8* %obj to %TestType*
        LVari* tobj = make_lvari_c(thgc, "%TestType*", "%tobj");
        add_list(thgc, fwdFunc->comps, (char*)make_lcast(thgc, LCAST_Bitcast, tobj, fwdP1));

        // Conv2d: load ptr from struct, load forward func, call
        LVari* conv_ptr = make_lvari_c(thgc, "%torch.nn.Conv2dImpl*", "%conv_ptr");
        LGete* geteconv = make_lgete(thgc, createString(thgc, (char*)"%TestType", 9, 1), conv_ptr, tobj);
        add_list(thgc, geteconv->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, geteconv->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, fwdFunc->comps, (char*)geteconv);

        LVari* conv = make_lvari_c(thgc, "%torch.nn.Conv2dImpl*", "%conv");
        add_list(thgc, fwdFunc->comps, (char*)make_lload(thgc, conv, conv_ptr, false));
        add_list(thgc, fwdFunc->comps, (char*)make_lload(thgc, lfconv, gfconv, false));

        LVari* x1 = make_lvari_c(thgc, "i8*", "%x1");
        LCall* forwardconv = make_lcall(thgc, x1, lfconv);
        add_list(thgc, forwardconv->comps, (char*)conv);
        add_list(thgc, forwardconv->comps, (char*)fwdP2);
        add_list(thgc, fwdFunc->comps, (char*)forwardconv);

        // ReLU
        LVari* relu_ptr = make_lvari_c(thgc, "%torch.nn.ReLUImpl*", "%relu_ptr");
        LGete* geterelu = make_lgete(thgc, createString(thgc, (char*)"%TestType", 9, 1), relu_ptr, tobj);
        add_list(thgc, geterelu->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, geterelu->comps, (char*)make_lvari_c(thgc, "i32", "1"));
        add_list(thgc, fwdFunc->comps, (char*)geterelu);

        LVari* relu = make_lvari_c(thgc, "%torch.nn.ReLUImpl*", "%relu");
        add_list(thgc, fwdFunc->comps, (char*)make_lload(thgc, relu, relu_ptr, false));
        add_list(thgc, fwdFunc->comps, (char*)make_lload(thgc, lfrelu, gfrelu, false));

        LVari* x2 = make_lvari_c(thgc, "i8*", "%x2");
        LCall* forwardrelu = make_lcall(thgc, x2, lfrelu);
        add_list(thgc, forwardrelu->comps, (char*)relu);
        add_list(thgc, forwardrelu->comps, (char*)x1);
        add_list(thgc, fwdFunc->comps, (char*)forwardrelu);

        // Flatten
        LVari* flat_ptr = make_lvari_c(thgc, "%torch.nn.FlattenImpl*", "%flat_ptr");
        LGete* geteflat = make_lgete(thgc, createString(thgc, (char*)"%TestType", 9, 1), flat_ptr, tobj);
        add_list(thgc, geteflat->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, geteflat->comps, (char*)make_lvari_c(thgc, "i32", "2"));
        add_list(thgc, fwdFunc->comps, (char*)geteflat);

        LVari* flat = make_lvari_c(thgc, "%torch.nn.FlattenImpl*", "%flat");
        add_list(thgc, fwdFunc->comps, (char*)make_lload(thgc, flat, flat_ptr, false));
        add_list(thgc, fwdFunc->comps, (char*)make_lload(thgc, lfflat, gfflat, false));

        LVari* x3 = make_lvari_c(thgc, "i8*", "%x3");
        LCall* forwardflat = make_lcall(thgc, x3, lfflat);
        add_list(thgc, forwardflat->comps, (char*)flat);
        add_list(thgc, forwardflat->comps, (char*)x2);
        add_list(thgc, fwdFunc->comps, (char*)forwardflat);

        // Linear
        LVari* line_ptr = make_lvari_c(thgc, "%torch.nn.LinearImpl*", "%line_ptr");
        LGete* geteline = make_lgete(thgc, createString(thgc, (char*)"%TestType", 9, 1), line_ptr, tobj);
        add_list(thgc, geteline->comps, (char*)make_lvari_c(thgc, "i32", "0"));
        add_list(thgc, geteline->comps, (char*)make_lvari_c(thgc, "i32", "3"));
        add_list(thgc, fwdFunc->comps, (char*)geteline);

        LVari* line = make_lvari_c(thgc, "%torch.nn.LinearImpl*", "%line");
        add_list(thgc, fwdFunc->comps, (char*)make_lload(thgc, line, line_ptr, false));
        add_list(thgc, fwdFunc->comps, (char*)make_lload(thgc, lfline, gfline, false));

        LVari* x4 = make_lvari_c(thgc, "i8*", "%x4");
        LCall* forwardline = make_lcall(thgc, x4, lfline);
        add_list(thgc, forwardline->comps, (char*)line);
        add_list(thgc, forwardline->comps, (char*)x3);
        add_list(thgc, fwdFunc->comps, (char*)forwardline);

        // ret i8* %x4
        add_list(thgc, fwdFunc->comps, (char*)make_lret(thgc, x4));
    }
...
int ldbg_get_pointer_type(ThreadGC* thgc, LDebugInfo* dbg, int baseTypeId) {
    ...
    add_list(thgc, dbg->ptrBaseIds, (char*)(intptr_t)baseTypeId);
    add_list(thgc, dbg->ptrTypeIds, (char*)(intptr_t)ptrTypeId);
    return ptrTypeId;
}

int ldbg_create_location(ThreadGC* thgc, LDebugInfo* dbg, LLocationMarker* lm) {
    int id = dbg->metaId++;
    add_list(thgc, dbg->locationKeys, (char*)(intptr_t)id);
...
void llvm_output_struct_type(ThreadGC* thgc, LLLVM* llvm, String* structName, int structId, SB* sb) {
    ...
    if (!val) {
        // Forward declaration for struct types that were referenced but not fully defined
        sb_addc(thgc, sb, '!');
        sb_addi(thgc, sb, structId);
        sb_adds(thgc, sb, " = !DICompositeType(tag: DW_TAG_structure_type, name: \"");
        sb_add_str(thgc, sb, structName);
        sb_adds(thgc, sb, "\", flags: DIFlagFwdDecl)\n");
        return;
    }
...
// ============================================================
// ExtractStructDebugInfo - port from C# LLVM.ExtractStructDebugInfo()
// Processes all type declarations to populate struct debug info
// ============================================================
void ldbg_define_struct_recursive(ThreadGC* thgc, LLLVM* llvm, LTypeDec* typeDec, int fileId, Map* processed) {
    String* structName = str_trim_start(thgc, typeDec->name, '%');

    // Skip if already processed
    if (get_mapy(processed, structName) != NULL) { return; }

    // Process dependencies first
    for (int i = 0; i < typeDec->comps->size; i++) {
        LTypeVal* tv = *(LTypeVal**)get_list(typeDec->comps, i);
        String* fieldType = tv->type;

        // If field is a struct type, define it first
        if (str_starts_with(fieldType, "%")) {
            String* depStructName = str_trim_start(thgc, fieldType, '%');
            depStructName = str_trim_end(thgc, depStructName, '*');

            if (get_mapy(processed, depStructName) == NULL) {
                // Find the dependency type declaration
                for (int j = 0; j < llvm->types->size; j++) {
                    LTypeDec* depTd = *(LTypeDec**)get_list(llvm->types, j);
                    if (depTd->func) continue;
                    String* depName = str_trim_start(thgc, depTd->name, '%');
                    if (depName->size == depStructName->size && depName->esize == depStructName->esize &&
                        memcmp(depName->data, depStructName->data, depName->size * depName->esize) == 0) {
                        ldbg_define_struct_recursive(thgc, llvm, depTd, fileId, processed);
                        break;
                    }
                }
            }
    ...
    List* fields = create_list(thgc, sizeof(LStructField*), CType::_LStructField);
    int offsetBits = 0;

    for (int i = 0; i < typeDec->comps->size; i++) {
        LTypeVal* tv = *(LTypeVal**)get_list(typeDec->comps, i);
        int sizeBits = llvm_get_type_size(llvm, tv->type);

        LStructField* f = (LStructField*)GC_alloc(thgc, _LStructField);
        f->name = tv->name;
        f->llvmType = tv->type;
        f->offsetInBits = offsetBits;
        f->sizeInBits = sizeBits;
        f->metaId = llvm->debugInfo->metaId++;
        add_list(thgc, fields, (char*)f);

        offsetBits += sizeBits;
    }

    // Store struct info
    int structId = ldbg_map_get_int(llvm->debugInfo->structTypeIds, structName);
    if (structId < 0) {
        structId = llvm->debugInfo->metaId++;
        ldbg_map_set_int(thgc, llvm->debugInfo->structTypeIds, structName, structId);
    }

    LStructTypeInfo* info = (LStructTypeInfo*)GC_alloc(thgc, _LStructTypeInfo);
    info->structId = structId;
    info->fileId = fileId;
    info->fields = fields;
    info->name = structName;
    add_mapy(thgc, llvm->debugInfo->structTypes, structName, (char*)info);

    // Mark as processed
    add_mapy(thgc, processed, structName, (char*)(intptr_t)1);
}

void ldbg_extract_struct_debug_info(ThreadGC* thgc, LLLVM* llvm) {
    int fileId = ldbg_create_file(thgc, llvm->debugInfo, llvm->sourceFile, llvm->directory);

    // 1. Reserve IDs for all struct types (forward declarations)
    for (int i = 0; i < llvm->types->size; i++) {
        LTypeDec* td = *(LTypeDec**)get_list(llvm->types, i);
        if (td->func) continue;
        ldbg_get_or_create_type(thgc, llvm->debugInfo, td->name);
    }

    // 2. Define structs recursively with dependency resolution
    Map* processed = create_mapy(thgc, CType::_Struct);
    for (int i = 0; i < llvm->types->size; i++) {
        LTypeDec* td = *(LTypeDec**)get_list(llvm->types, i);
        if (td->func) continue;
        ldbg_define_struct_recursive(thgc, llvm, td, fileId, processed);
    }
}
...
void llvm_output(ThreadGC* thgc, LLLVM* llvm, SB* sb) {
    // Extract struct debug info before output (matches C# ExtractStructDebugInfo())
    ldbg_extract_struct_debug_info(thgc, llvm);
    ...
    // 旧 TreeElement struct は廃止。tag 管理フィールドも全て削除し、thgc->map のみで
    // id 経由 lookup を行う。checkTreeElement は ElementType* を直接返す (= 互換のため
    // signature 不変、parentt / deletes 引数は受け取るが内部で使わない)。
    sb_adds(thgc, sb, "%CheckTreeElementType = type %ElementType* (%ThreadGCType*, %ElementType*, %ElementType*, %ListType*, %StringType*, i32, i32, ptr)*\n");
...
bool llvm_compile(ThreadGC* thgc, LLLVM* llvm, const char* name) {
    ...
    // Run clang to produce DLL, capture errors
    char cmd[2048];
    snprintf(cmd, sizeof(cmd),
        "cd clang3 && clang++ -std=c++20 -g -gdwarf-4 -O0 -fuse-ld=lld -shared "
        "%s.ll -o %s.dll -Wl,/IMPLIB:%s 2>&1",
        name, name, name);
    ...
    if (ret != 0) {
        printf("[clang] build failed with code %d\n", ret);
        return false;
    }
    return true;
}

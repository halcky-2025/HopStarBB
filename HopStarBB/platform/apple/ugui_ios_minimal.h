    ...
    uint8_t viewId)
{
    ...
    if (commands[0]->texture3 && bgfx::isValid(*commands[0]->texture3)) tex3 = *commands[0]->texture3;
    bgfx::TextureHandle tex4 = resources.placeholderTexture;
    if (commands[0]->texture4 && bgfx::isValid(*commands[0]->texture4)) tex4 = *commands[0]->texture4;
